...
/*
Dividir as tabelas grandes em partições para melhorar o desempenho e facilitar o gerenciamento de dados
...
GO
-- Criaremos um esquema de particionamento que define como as partições serão distribuidas. (Não os dados)
CREATE PARTITION SCHEME ps_ano
AS PARTITION pf_ano
-- Cada participação será mapeada aqui no TO, nesse caso todas partições estão sendo alocadas no PRIMARY.
